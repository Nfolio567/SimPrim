                ...
                if (!this.isAnimating) {
                    ...
                    this.draggingFrame = requestAnimationFrame(() => {
                        ...
                        if (this.img && this.trimming && this.dx !== undefined && this.dy !== undefined) {
                            (_a = this.inputCtx) === null || _a === void 0 ? void 0 : _a.drawImage(this.img, this.beforeDx, this.beforeDy, this.drawTrimmingWidth, this.drawTrimmingHeight, this.beforeDx, this.beforeDy, this.drawTrimmingWidth, this.drawTrimmingHeight);
